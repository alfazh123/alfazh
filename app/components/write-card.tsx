export default function WriteCard({
	...
	return (
		<a
			...
			className={`group relative p-4 rounded-lg flex justify-end items-end text-end rotate-6 md:hover:scale-110 transition-transform duration-300 aspect-4/3 skew-2 ${className ?? ""}`}>
